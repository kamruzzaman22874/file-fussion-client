                                        ...
                                        <div>
                                            ...
                                            <div className="mt-8 space-y-7">
                                                <div className="flex items-start">
                                                    ...
                                                    <span className="block ml-3 text-base text-gray-900"> Sector-6,Road-8 Alawal Avenue, Uttara, Dahaka-1230 </span>
                                                </div>
                                                ...
                                                <div className="flex items-start">
                                                    ...
                                                    <div className="ml-3">
                                                        <span className="block text-base text-gray-900"> +8801989214721 </span>
                                                        <span className="block mt-1 text-base text-gray-900"> +8801319101179 </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
