...
const Pricing = () => {
    return (
        <div>
            <section className="py-5  sm:py-10 lg:py-12 bg-gradient-to-r from-fuchsia-600 to-blue-600 text-white">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="max-w-xl mx-auto text-center">
                        <h2 className="text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl">Pricing & Plans</h2>
                        <p className="mt-4 text-lg leading-relaxed ">Amet minim mollit non deserunt ullam co est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
                    </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th className="px-4 py-8 text-center">
                                        ...
                                        <p className="mt-2 text-base font-normal ">Per month</p>
                                    </th>
