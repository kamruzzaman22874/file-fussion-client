...
const OurUser = () => {
    return (
    <>
      <section className='container mx-auto mt-8 rounded-md bg-gradient-to-r from-fuchsia-200 to-blue-200'>
    <div className="py-10 ">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold leading-tight text-center sm:text-4xl lg:text-5xl">You’ll be in great company</h2>
        </div>
    </div>
    ...
    <div className="grid grid-cols-4 md:grid-cols-6 xl:grid-cols-11">
        ...
        <div>
            <div className="bg-orange-500 aspect-w-1 aspect-h-1">
                <div className="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                    <p className="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Vip</p>
                    <p className="mt-2 text-sm text-white truncate">Customer</p>
                </div>
            </div>
        </div>
        ...
        <div>
            <div className="bg-blue-500 aspect-w-1 aspect-h-1">
                <div className="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                    <p className="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Premium</p>
                    <p className="mt-2 text-sm text-white truncate">Customer</p>
                </div>
            </div>
        </div>
        ...
        <div>
            <div className="bg-gray-700 aspect-w-1 aspect-h-1">
                <div className="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                    <p className="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Asian</p>
                    <p className="mt-2 text-sm text-white truncate">Customer</p>
                </div>
            </div>
        </div>
        ...
        <div>
            <div className="bg-green-400 aspect-w-1 aspect-h-1">
                <div className="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                    <p className="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">European</p>
                    <p className="mt-2 text-sm text-white truncate">Customer</p>
                </div>
            </div>
        </div>
        ...
        <div>
            <div className="bg-red-500 aspect-w-1 aspect-h-1">
                <div className="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                    <p className="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Previous</p>
                    <p className="mt-2 text-sm text-white truncate">Customer</p>
                </div>
            </div>
        </div>
        ...
        <div>
            <div className="bg-gray-800 aspect-w-1 aspect-h-1">
                <div className="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                    <p className="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Regular</p>
                    <p className="mt-2 text-sm text-white truncate">Customer</p>
                </div>
            </div>
        </div>
        ...
        <div>
            <div className="bg-indigo-500 aspect-w-1 aspect-h-1">
                <div className="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                    <p className="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Classic</p>
                    <p className="mt-2 text-sm text-white truncate">Customer</p>
                </div>
            </div>
        </div>
